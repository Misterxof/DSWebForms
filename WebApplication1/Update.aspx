    ...
    <div>
        ...
        <asp:Menu ID="Menu1" runat="server" BackColor="#F7F6F3" DynamicHorizontalOffset="2" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#7C6F57" StaticSubMenuIndent="10px">
            ...
            <Items>
                ...
                <asp:MenuItem Text="Изменение" Value="Изменение"></asp:MenuItem>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="playerid" DataSourceID="AccessDataSource1" EmptyDataText="There are no data records to display." HorizontalAlign="Center">
            <Columns>
